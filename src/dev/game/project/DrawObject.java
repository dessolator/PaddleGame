...
public class DrawObject {
	private static final int circleIter=8;
	...
	public static void drawCirclef(float x, float y, float radius) {
	    ...
	    {
	        for (float angle = 0; angle < circleIter; angle += 0.5) {//@revision implemented circleIter constant, 360 iterations is a little too expensive for a circle
